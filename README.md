...
| `components/TaskList.tsx` | Aynı durumdaki görevleri kolon olarak listeler, boş durum arayüzünü gösterir ve görev geçiş animasyonlarını yönetir. |
...
| Framer Motion | Frontend animasyonları | Görevlerin ve çalışma alanlarının geçişlerini daha akıcı hale getirir | Ekran geçişleri ve görev hareketleri animasyonsuz gerçekleşir. |
